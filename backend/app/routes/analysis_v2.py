...
async def analyze_resume(
    ...
    try:
        ...
        exp_match, exp_explanation, matched_areas, gaps = (
            analyzer.analyze_experience_match(resume_text, jobDescription)
        )
        ...
        improved_bullets_data = analyzer.generate_improved_bullets(
            resume_text, jobDescription
        )
        ...
        matched_kw, missing_kw, matched_count, missing_count = (
            analyzer.generate_keyword_analysis(resume_text, jobDescription)
        )

        # 7. Calculate skill gap score
        skill_gap_score = analyzer.calculate_skill_gap_score(
