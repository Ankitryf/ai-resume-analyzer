from sqlalchemy import Column, Integer, String, Text, Float, DateTime, ForeignKey, Boolean, JSON, ARRAY
...
class AnalysisResult(Base):
    ...
    readiness_level = Column(String)  # "Ready Now", "Ready with Projects", "Needs More Work"
    ...
    experience_analyses = relationship("ExperienceAnalysis", back_populates="analysis", cascade="all, delete-orphan")
    project_analyses = relationship("ProjectAnalysis", back_populates="analysis", cascade="all, delete-orphan")
    skill_gaps = relationship("SkillGap", back_populates="analysis", cascade="all, delete-orphan")
    project_recommendations = relationship("ProjectRecommendation", back_populates="analysis", cascade="all, delete-orphan")
    resume_bullets = relationship("ResumeBullet", back_populates="analysis", cascade="all, delete-orphan")
    improved_bullets = relationship("ImprovedBullet", back_populates="analysis", cascade="all, delete-orphan")
